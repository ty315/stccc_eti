...
def recognizing(i, k):
    #画像の保存先
    SAVE_DATA_IMAGE_PATH = f"/Users/tyama/Desktop/marksheet/num_output_{i:05d}/"
    # 画像の読み込みと表示
    img = cv2.imread(SAVE_DATA_IMAGE_PATH + f"/tegaki_{k:02d}_prepro.jpg")
    ...
    SAVE_DATA_DIR_PATH = "/Users/tyama/Desktop/marksheet/keras/"
    ...
    # 予想した数字の正答確率
    probability_number = max(np.round(predict_y[0], 1))
    ...
    """
    predict_y: [0.    0.    0.    0.    0.    0.003 0.997 0.    0.    0.   ]
    predict_number: 6
    """
